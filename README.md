...
open write window and have unboundedly undefined effects when performed without
a write window open (such as when there is no window or a read window open).
