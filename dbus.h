...
#define DBUS_C_STATE		0x07
#define NUM_DBUS_CMDS		(DBUS_C_STATE + 1)
...
/* Response Args */
/* Status */
#define STATUS_NUM_ARGS		1
#define STATUS_ACTIVE		0x00 /* Daemon Active */
#define STATUS_SUSPENDED	0x01 /* Daemon Suspended */
/* LPC State */
#define STATE_NUM_ARGS		1
#define STATE_INVALID		0x00 /* Invalid State */
#define STATE_FLASH		0x01 /* LPC Maps Flash Directly */
#define STATE_MEM		0x02 /* LPC Maps Memory */
