...
### Version 2 Status Code Additions
...
### Version 3 Status Code Additions
...
Specifically, commands are represented by DBus methods and events are represented
by properties for level-triggered (persistent) events and signals for
edge-triggered (acknowledgeable) events. DBus will automatically generate a
