...
class Table
{
    public:
        ...
        /** @brief Return pointer to a partition table having byte-ordering
         *         that the host expects. Caller has to  deallocate memory
         ...
         */
        pnor_partition_table* generateHostTable() const
        {
         ...
         */
        const pnor_partition_table* const getNativeTable() const
        {
            return tbl;
        }
